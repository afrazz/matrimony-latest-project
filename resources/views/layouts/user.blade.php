                                    ...
                                    <div x-data="{ show: false }" x-on:click.away="show = false" class="ml-3 relative">
                                        ...
                                        <div x-show="show"
                                            ...
                                            @if ($userProfileExists)
                                                <a href="{{ route('showprofile')}}" class="block px-4 py-2 text-sm text-gray-700"
                                                    role="menuitem" tabindex="-1" id="user-menu-item-0">Show Profile</a>
                                            @else
                                                <a href="{{ route('userprofile') }}"
                                                    class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                                    tabindex="-1" id="user-menu-item-0">Create Profile</a>
                                            @endif
